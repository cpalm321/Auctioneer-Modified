...
local serverVersion = select(4, GetBuildInfo())
private.serverVersion = serverVersion
local expVersion = floor(serverVersion / 10000)
if serverVersion < 80300 then
	private.IsClassic = expVersion
else
	private.IsRetail = expVersion
end
