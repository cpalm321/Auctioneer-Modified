...
function private.HookAH()
	...
	local check = CreateFrame("CheckButton", nil, AuctionFrameBrowse, "OptionsSmallCheckButtonTemplate")
...
private.switchUI = CreateFrame("Button", nil, UIParent, "UIPanelButtonTemplate")
