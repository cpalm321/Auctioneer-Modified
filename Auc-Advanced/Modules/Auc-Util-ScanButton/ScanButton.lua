...
function private.HookAH()
	...
	private.buttons.stop = CreateFrame("Button", nil, private.buttons, "UIPanelButtonTemplate")
	private.buttons.stop:SetPoint("TOPLEFT", private.buttons, "TOPLEFT", 0,0)
	private.buttons.stop:SetSize(22, 18)
	...
	private.buttons.play = CreateFrame("Button", nil, private.buttons, "UIPanelButtonTemplate")
	private.buttons.play:SetPoint("TOPLEFT", private.buttons.stop, "TOPRIGHT", 2,0)
	private.buttons.play:SetSize(22, 18)
	...
	private.buttons.pause = CreateFrame("Button", nil, private.buttons, "UIPanelButtonTemplate")
	private.buttons.pause:SetPoint("TOPLEFT", private.buttons.play, "TOPRIGHT", 2,0)
	private.buttons.pause:SetSize(22, 18)
	...
	private.buttons.getall = CreateFrame("Button", nil, private.buttons, "UIPanelButtonTemplate")
	private.buttons.getall:SetPoint("TOPLEFT", private.buttons.pause, "TOPRIGHT", 2,0)
	private.buttons.getall:SetSize(22, 18)
	...
	msg.Done = CreateFrame("Button", nil, msg, "UIPanelButtonTemplate")
	msg.Done:SetSize(90, 21)
	msg.Done:SetText("Done")
	msg.Done:SetPoint("BOTTOMRIGHT", msg, "BOTTOMRIGHT", -10, 10)
	msg.Done:SetScript("OnClick", function() msg:Hide() end)

	msg.Text = msg:CreateFontString(nil, "OVERLAY")
