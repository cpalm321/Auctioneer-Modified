...
EnchantrixLocalizations = {
	...
	csCZ = {
		...
		["GuiActivateProfile"]	= "Aktivovat stávající profil";
		["GuiAutoDEPurchaseReason"]	= "Koupit za %s";
		["GuiCreateReplaceProfile"]	= "Vytvořit nebo nahradit profil";
		["GuiDeleteProfileButton"]	= "Smazat";
		["GuiDuplicateProfileButton"]	= "Kopírovat profil";
		["GuiIgnore"]	= "Ignorovat¶";
	...
	daDK = {
		...
		-- Section: Tooltip Messages
		["Click"]	= "Klik";
		["EnxMMTip"]	= "Enchantrix viser hvilke 'reagents' en ting vil disenchantes, eller milles til. Den integrere også med Auctioneer for at bestemme pricer for køb/salg.";
		...
		["RightClick"]	= "Højre-Klik";
		["ShiftClick"]	= "Shift-Klik";
		["TipOpenConfig"]	= "For at ændre indstillingerne.";
		["TipOpenEnchant"]	= "for at åbne Enchanting vinduet.";
		["TipOpenJewel"]	= "for at åbne Jewel Crafting vinduet.";
		...
		["GuiAutoDeBoughtForDE"]	= "Kun købte ting skal disenchantes";
		["GuiAutoDeEnable"]	= "Kig i inventory for 'disenchantable' ting - PAS PÅ¶";
		["GuiAutoDeEpicItems"]	= "Auto Disenchant epic (lilla) ting";
		["GuiAutoDeOptions"]	= "Automatisering";
		["GuiAutoDePromptLine1"]	= "Vil du disenchante:";
		["GuiAutoDePromptLine3"]	= "Vurderet til %s";
		["GuiAutoDEPurchaseReason"]	= "Købt for %s";
		["GuiAutoDeRareItems"]	= "Auto Disenchant rare (blå) ting";
	...
	deDE = {
		...
		-- Section: Help Text
		["GuiAltChatlink"]	= "Öffne Tooltips von Chat Links mit ALT links-klick";
		...
		["HelpAltChatlink"]	= "Ermöglicht das Öffnen eines Tooltip beim links-klicken auf einen Gegenstand Link im Chat während die Alt-Taste gedrückt wird.";
		...
		-- Section: Tooltip Messages
		["Click"]	= "Klick";
		["EnxMMTip"]	= "Enchantrix zeigt an in was ein Item entzaubert, gemahlen oder sondiert werden kann. Es integriert sich in Auctioneer um Preis- und Kaufentscheidungen zu ermöglichen.";
		...
		["TipOpenConfig"]	= "um die Konfiguration zu bearbeiten";
		["TipOpenEnchant"]	= "um das Verzauberungsfenster zu öffnen";
		["TipOpenJewel"]	= "um das Fenster für's Juwelenschmieden zu öffnen";
		...
		["GuiAutoLootDE"]	= "Automatisches looten von manuell entzauberten, sondierten oder gemahlenen Sachen";
		...
		["GuiShowMatSources"]	= "Zeige Ursprungsmaterialien für Gegenstände erworben durch entzaubern, sondieren und mahlen.";
		...
		["ModTTShow_ctrl"]	= "Wenn Strg gedrückt wird";
		["ModTTShow_never"]	= "Nie";
		["ModTTShow_noalt"]	= "Wenn Alt nicht gedrückt wird";
		["ModTTShow_noctrl"]	= "Wenn Strg nicht gedrückt wird";
		["ModTTShow_noshift"]	= "Wenn Shift nicht gedrückt wird";
		["ModTTShow_shift"]	= "Wenn Shift gedrückt wird";
	...
	enUS = {
		...
		["GuiAutoLootDE"]	= "Automatically loot manually disenchanted, prospected, or milled items.";
	...
	esES = {
		...
		["FrmtProspectFrom"]	= "Se prospecciona de %s.";
		...
		-- Section: User Interface
		["BeanCounterRequired"]	= "Se requiere BeanCounter para determinar la razón de compra. AutoDE será desactivado hasta que se instale BeanCounter.";
		["ExportPriceAucAdv"]	= "Exportar precios de Enchantrix a Auctioneer Advanced";
		["GuiActivateProfile"]	= "Activar el perfil actual";
		["GuiAutoDeBoughtForDE"]	= "Solamente artículos comprados para desencantar.";
		["GuiAutoDeEnable"]	= "Monitorizar bolsas por objetos desencantables - USAR CON PRECAUCIÓN";
		["GuiAutoDeEpicItems"]	= "Auto desencantar objetos de calidad épica (morados)";
		["GuiAutoDeOptions"]	= "Automatización";
		["GuiAutoDePromptLine1"]	= "¿Quieres desencantar:¶";
		["GuiAutoDePromptLine3"]	= "Valorado en %s¶";
		["GuiAutoDEPurchaseReason"]	= "Fue Comprado por %s";
		["GuiAutoDeRareItems"]	= "Auto desencantar objetos de calidad rara (azules)";
		["GuiAutoDESuggestion"]	= "Sugerencia: %s este artículo";
		["GuiAutoLootDE"]	= "Recoger automaticamente objetos desencantados, prospeccionados o molidos.";
		...
		["GuiShowMatSources"]	= "Muestre el material de origen de artículos obtenidos por desencante, prospección, o molidos.";
	...
	frFR = {
		...
		["FrmtActUnknownLocale"]	= "La langue que vous avez spécifiée ('%s') est inconnue. Les langues valides sont :";
		...
		["GuiClearallNote"]	= "pour la faction actuelle";
		["GuiDefaultAll"]	= "Réinitialiser toutes les options d'Enchantrix";
		["GuiDefaultAllButton"]	= "Tout réinitialiser";
		["GuiDefaultAllHelp"]	= "Cliquer ici pour réinitialiser toutes les options d'Enchantrix.\nATTENTION : Cette opération est irréversible.";
		...
		["GuiMainHelp"]	= "Contient les règlages d'Enchantrix,\nun AddOn affichant les informations liées au désenchantement.";
		...
		["GuiShowCraftReagents"]	= "Afficher les composants d'enchantements dans la bulle d'aide";
		["GuiTerse"]	= "Active le mode concis";
		["GuiValuateAverages"]	= "Évaluer avec les moyennes d'Auctioneer";
		["GuiValuateBaseline"]	= "Évaluer avec les données intégrées";
		...
		["HelpFindBuyauct"]	= "Trouver les enchères dont la valeur de désenchantement potentielle est inférieure d'un certain pourcentage au prix d'achat immédiat.";
		["HelpGuessAuctioneer5Val"]	= "Si l'évaluation est activée, et qu'Auctioneer est activé, affiche la valeur de l'objet désenchanté.";
		["HelpGuessAuctioneerHsp"]	= "Si l'évaluation est activé et qu'Auctioneer est installé, affiche l'estimation de plus haut prix de vente (HSP) de désenchantement de cet objet.";
		["HelpGuessAuctioneerMedian"]	= "Si l'évaluation est activé et qu'Auctioneer est installé, affiche l'évaluation basée sur la moyenne de désenchantement de l'objet.";
		["HelpGuessBaseline"]	= "Si l'évaluation est activée (Auctioneer n'est pas nécessaire), affiche les informations de base de désenchantement, en s'appuyant sur la liste de prix intégrée.";
		["HelpGuessNoauctioneer"]	= "Les commandes \"evaluer-hsp\" et \"evaluer-moyenne\" ne sont pas disponibles car Auctioneer n'est pas installé";
		["HelpLoad"]	= "Change les réglages de chargement d'Enchantrix pour ce personnage";
		...
		["HelpTerse"]	= "Active ou désactive le mode concis, qui ne montre que les valeurs de désenchantement. Peut être annulé en maintenant la touche Ctrl enfoncée.";
		...
		["AuctionScanVersionTooOld"]	= "Vous n'avez pas la bonne version d'Auctioneer installée, cette fonctionnalité requiert Auctioneer v4.0 ou supérieur.";
		...
		["FrmtAutoDeIgnorePermanent"]	= "Ignorer %s en permanence";
		...
		["FrmtBidbrokerLine"]	= "%s, Estimé à : %s, %s: %s, Économie de: %s, Moins %s, Temps : %s";
		["FrmtBidbrokerMinbid"]	= "EnchMin";
		["FrmtBidBrokerSkipped"]	= "%d enchères ignorées car marge trop faible (%d%%)";
		["FrmtBidBrokerSkippedBids"]	= "%d enchères ignorées car vous êtes enchérisseur";
		...
		["FrmtPctlessLine"]	= "%s, Estimé à : %s, AI : %s, Économie de : %s, Moins %s";
		...
		["FrmtFound"]	= "%s a été désenchanté en :";
		["FrmtFoundNotDisenchant"]	= "%s ne peut pas être désenchanté";
		["FrmtInkFrom"]	= "Fait de %s";
		["FrmtMillingFound"]	= "%s se moud en :";
		["FrmtMillingValueAuctHsp"]	= "Valeur de mouture (HSP)";
		["FrmtMillingValueAuctMed"]	= "Valeur de mouture (moyenne)";
		...
		["FrmtProspectValueAuctMed"]	= "Valeur prospectée (moyenne)";
		...
		["GuiAutoLootDE"]	= "Automatiquement le butin manuellement désenchanté, la prospection, ou blanchi articles.";
	...
	itIT = {
		...
		["CmdToggle"]	= "inverti";
		["ConfigUI"]	= "config";
		["ShowDELevels"]	= "livelli";
		["ShowDEMaterials"]	= "materiali";
		["ShowEmbed"]	= "integra";
		["ShowGuessAuctioneerHsp"]	= "valuta-hsp";
		["ShowGuessAuctioneerMed"]	= "valuta-mediana";
		["ShowGuessAuctioneerVal"]	= "valuta-valore";
		...
		-- Section: Help Text
		["GuiAltChatlink"]	= "Apri i suggerimenti dai link di chat con il tasto Alt sinistro";
		["GuiClearall"]	= "Cancella tutti i data di Enchantrix";
		...
		["GuiDELevels"]	= "Mostra il livello richiesto per distruggere l'oggetto nei suggerimenti";
		["GuiDEMaterials"]	= "Mostra le informazioni nei suggerimenti sui materiali disincantati";
		["GuiEmbed"]	= "Aggiungi le informazioni ai suggerimenti";
		...
		["GuiPrintYieldsInChat"]	= "Mostra in chat la resa dell'oggetto";
		["GuiShowCraftReagents"]	= "Mostra nei suggerimenti i materiali";
		...
		["HelpAltChatlink"]	= "Attiva l'apertura dei suggerimenti cliccando con il tasto sinistro su un oggetto evidenziato in chat, mentre è premuto il tasto Alt.";
		...
		["HelpGuessAuctioneer5Val"]	= "Se la valutazione Ã¨ attivata, e Auctioneer Ã¨ installato, mostra il valore di vendita per distruggere l'oggetto.";
		...
		["HelpShowDELevels"]	= "Decide se mostrare l'abilità di incantamento necessaria per disincantare l'oggetto nei suggerimenti.";
		["HelpShowDEMaterials"]	= "Decide se mostrare nei suggerimenti i possibili materiali ottenuti, disincantando l'oggetto.";
		["HelpShowUI"]	= "Mostra o nascondi il pannello delle opzioni.";
		...
		["ModTTShow_Help"]	= "Decide il comportamento dei suggerimenti: Sempre: Mostra sempre i suggerimenti di Enchantrix. Quando viene premuto <mod>: mostra i suggerimenti di Enchantrix solo se il seguente tasto viene premuto. Quando non è premuto <mod>: mostra i suggerimenti di Enchantrix solo se il seguente tasto non è premuto. Mai: non mostra mai i suggerimenti di Enchantrix.";

		-- Section: Report Messages
		["AuctionScanAuctNotInstalled"]	= "Non hai Auctioneer installato. Auctioneer deve essere installato per scansionare l'asta.";
		["AuctionScanVersionTooOld"]	= "Non hai la versione corretta di Auctioneer installata, questa funzione richiede Auctioneer v4.0 o successive.";
		["ChatDeletedProfile"]	= "Profilo eliminato:";
		["ChatDuplicatedProfile"]	= "Profilo duplicato:";
		["ChatResetProfile"]	= "Reimposta tutte le opzioni per:";
		["ChatSavedProfile"]	= "Profilo salvato:";
		["ChatUsingProfile"]	= "Profilo ora attivo:";
		["FrmtAutoDeActive"]	= "Disincantamento automatico attivo";
		["FrmtAutoDeDisabled"]	= "Disincantamento automatico disattivato";
		["FrmtAutoDeDisenchantCancelled"]	= "Disincantamento cancellato: oggetto non trovato";
		["FrmtAutoDeDisenchanting"]	= "Disincantamento %s";
		["FrmtAutoDeIgnorePermanent"]	= "Ignoro %s sempre";
		["FrmtAutoDeIgnoreSession"]	= "Ignoro %s per questa sessione";
		["FrmtAutoDeInactive"]	= "Disincantamento automatico inattivo";
		["FrmtAutoDeMilling"]	= "Pestatura %s";
		["FrmtAutoDeMillingCancelled"]	= "Pestatura cancellata: oggetto non trovato";
		["FrmtAutoDeProspectCancelled"]	= "Taglio delle gemme cancellato: oggetto non trovato";
		["FrmtAutoDeProspecting"]	= "Taglio delle gemme %s";
		["FrmtBidbrokerCurbid"]	= "curBid";
		...
		["FrmtBidBrokerSkippedBids"]	= "Saltate %d aste a causa di offerte già presenti";
		...
		["FrmtPctlessSkillSkipped"]	= "Saltate %d aste a causa del livello di abilità eliminato (%s)";
		["FrmtPctlessSkipped"]	= "Saltate le aste %d per un taglio del profitto (%s)";

		-- Section: Tooltip Messages
		["Click"]	= "Clic";
		["EnxMMTip"]	= "Enchantrix ti mostra che materiali ti offrirà disincantare, tagliare o pestare. Aggiunge inoltre un'integrazione con Auctioneer per decisioni in merito al prezzo di vendita o acquisto.";
		["FrmtBarkerPrice"]	= "Prezzo imbonitore (margine %d%%)";
		["FrmtDEItemLevels"]	= "Disincantabile dal livello dell'oggetto %d a %d.";
		["FrmtDisinto"]	= "Si disincanta in:";
		["FrmtFound"]	= "%s si disincanta in:";
		["FrmtFoundNotDisenchant"]	= "L'oggetto %s non è disincantabile";
		["FrmtInkFrom"]	= "Fatto da %s";
		["FrmtMillingFound"]	= "%s si pesta in:";
		["FrmtMillingValueAuctHsp"]	= "Valore di Pestatura (Val.Più Alto)";
		["FrmtMillingValueAuctMed"]	= "Valore di pestatura (Medio)";
		["FrmtMillingValueAuctVal"]	= "Valore di pestatura (Val.Attuale)";
		["FrmtMillingValueMarket"]	= "Valore di pestatura (Base)";
		["FrmtMillsInto"]	= "Si pesta in:";
		["FrmtPriceEach"]	= "(%s ognuno)";
		["FrmtProspectFound"]	= "%s si taglia in:";
		["FrmtProspectFrom"]	= "Può essere tagliato da %s.";
		["FrmtProspectInto"]	= "Stringa suggerimento sulle possibilità di taglio delle gemme";
		["FrmtProspectValueAuctHsp"]	= "Valore taglio delle gemme (Più Alto)";
		["FrmtProspectValueAuctMed"]	= "Valore taglio delle gemme (Medio)";
		["FrmtProspectValueAuctVal"]	= "Valore taglio delle gemme (Val.Attuale)";
		["FrmtProspectValueMarket"]	= "Valore taglio delle gemme (Base)";
		...
		["FrmtValueAuctVal"]	= "Valore di disincantamento (Val.Attuale)";
		["FrmtValueFixedVal"]	= "Valore di disincantamento (Val.Fisso)";
		...
		["ShiftClick"]	= "Maiuscole-Clic Sinistro";
		["TipOpenConfig"]	= "per modificare le opzioni.";
		["TipOpenEnchant"]	= "per aprire la finestra Incantamento.";
		["TipOpenJewel"]	= "per aprire la finestra Oreficeria.";
		["TooltipMillingLevel"]	= "Pestare richiede l'abilità %d";
		["TooltipProspectLevel"]	= "Tagliare le gemme richiede l'abilità %d";
		["TooltipShowDisenchantLevel"]	= "Disincantare richiede l'abilità %d";

		-- Section: User Interface
		["BeanCounterRequired"]	= "E' richiesto BeanCounter per determinare la ragione d'acquisto. Disattivo AutoDE fino a quando BeanCounter non sarà installato.";
		["ExportPriceAucAdv"]	= "Esporta i prezzi di Enchantrix ad Auctioneer Advanced";
		["GuiActivateProfile"]	= "Attiva il profilo attuale";
		["GuiAutoDeBoughtForDE"]	= "Solo gli oggetti acquistati per il disincantamento";
		["GuiAutoDeEnable"]	= "Controlla Inventario per oggetti da disincantare - USARE CON ATTENZIONE";
		["GuiAutoDeEpicItems"]	= "Disincanta automaticamente gli oggetti epici (viola)";
		["GuiAutoDeOptions"]	= "Automazione";
		["GuiAutoDePromptLine1"]	= "Vuoi disincantare:";
		["GuiAutoDePromptLine3"]	= "Valutato a %s";
		["GuiAutoDEPurchaseReason"]	= "Comprato per %s";
		["GuiAutoDeRareItems"]	= "Disincanta automaticamente gli oggetti rari (blu)";
		["GuiAutoDESuggestion"]	= "Suggerimento: %s questo oggetto";
		["GuiAutoLootDE"]	= "Raccogli automaticamente gli oggetti disincantati, tagliati o pestati.";
		["GuiAutoMillingPromptLine1"]	= "Vuoi pestare:";
		["GuiAutoProspectPromptLine1"]	= "Vuoi tagliare:";
		["GuiBBUnbiddedOnly"]	= "Restringi BidBroker solo ad oggetti senza offerta";
		["GuiConfigProfiles"]	= "Crea, configura e modifica profili";
		["GuiCreateReplaceProfile"]	= "Crea o rimpiazza un profilo";
		["GuiDefaultBBProfitPercent"]	= "Percentuale profitto bidbroker predefinita: %d";
		["GuiDefaultLessHSP"]	= "Percentuale predefinita meno del Max.Possibile: %d";
		["GuiDefaultProfitMargin"]	= "Margine di Profitto Predefinito:";
		["GuiDeleteProfileButton"]	= "Elimina";
		["GuiDuplicateProfileButton"]	= "Copia Profilo";
		["GuiFixedSettings"]	= "Prezzi fissi reagenti";
		["GuiFixedSettingsNote"]	= "Nota: saranno usati i seguenti valori anzichè quelli di Auctioneer o di ogni altro metodo di valutazione, se selezioni questa casella. I seguenti valori saranno comunque influenzati dal peso dei reagenti nella sezione precedenti, quindi se vuoi essere sicuro che il reagente sia valutato esattamente alla somma specificata, assicurati allora che il suo peso sia impostato al 100% nella sezione pesi.";
		["GuiGeneralOptions"]	= "Opzioni Generali di Enchantrix";
		["GuiIgnore"]	= "Ignora";
		["GuiItemValueAuc4HSP"]	= "Asta4 Max.Possibile";
		["GuiItemValueAuc4Median"]	= "Asta4 Medio";
		["GuiItemValueAuc5Appraiser"]	= "AstaAvanzata Valore Esperto";
		["GuiItemValueAuc5Market"]	= "AstaAvanzata Valore Mercato";
		["GuiItemValueAverage"]	= "Medio (predefinito)";
		["GuiItemValueBaseline"]	= "Prezzo Base Mercato";
		["GuiItemValueCalc"]	= "Valore dell'oggetto calcolato da";
		["GuiMaxBuyout"]	= "Prezzo Massimo di Acquisto";
		["GuiMillingingValues"]	= "Mostra i potenziali valori di pestatura";
		["GuiMillingLevels"]	= "Mostra nella descrizione il livello di Pestatura richiesto";
		["GuiMillingMaterials"]	= "Mostra nella descrizione le informazioni sui materiali della pestatura";
		["GuiMillingOptions"]	= "Opzioni Pestatura";
		["GuiMinBBProfitPercent"]	= "Percentuale di profitto Minima bidbroker: %d";
		["GuiMinimapButtonAngle"]	= "Angolo bottone: %d";
		["GuiMinimapButtonDist"]	= "Distanza: %d";
		["GuiMinimapOptions"]	= "Opzioni finestra minimappa";
		["GuiMinimapShowButton"]	= "Mostra il tasto accanto alla Minimappa";
		["GuiMinLessHSP"]	= "Percentuale minima più bassa del Prezzo Max.: %d";
		["GuiMinProfitMargin"]	= "Margine di profitto Minimo:";
		["GuiNewProfileName"]	= "Nome nuovo profilo:";
		["GuiNo"]	= "No";
		["GuiPLBBOnlyBelowDESkill"]	= "Mostra solo gli oggetti disincantabili con l'abilità attuale";
		["GuiPLBBSettings"]	= "Impostazioni Percentless e BidBroker";
		["GuiProspectingLevels"]	= "Mostra nella descrizione il livello di abilità richiesto per il taglio";
		["GuiProspectingMaterials"]	= "Mostra nella descrizione le informazioni sui materiali del Taglio Gemme";
		["GuiProspectingOptions"]	= "Opzioni Taglio Gemme";
		["GuiProspectingValues"]	= "Mostra i possibili valori di Taglio";
		["GuiResetProfileButton"]	= "Riavvia";
	...
	koKR = {
		...
		["FrmtPrintin"]	= "Enchantrix의 메세지는 이제 \"%s\" 채팅창에 출력됩니다.";
		["FrmtUsage"]	= "사용법:";
		["MesgDisable"]	= "Enchantrix를 자동 로딩하지 않습니다.";
		["MesgNotloaded"]	= "Enchantrix가 로드되지 않았습니다. 더 많은 정보는 /enchantrix 를 입력하세요.";
		...
		["FrmtWelcome"]	= "Enchantrix v%s 로딩 완료";
		["MesgAuctVersion"]	= "Enchantrix는 Auctioneer 4.0 버전 이상이 필요합니다. 업데이트 전까지 몇몇 기능을 사용할 수 없습니다.";
		...
		["GuiDELevels"]	= "툴팁에 마력 추출에 필요한 레벨을 보여줍니다.";
		["GuiDEMaterials"]	= "툴팁에 마력 추출 재료 정보를 보여줍니다.";
		...
		["ChatDeletedProfile"]	= "프로필 삭제:";
		["ChatDuplicatedProfile"]	= "프로필 복제:";
		["ChatResetProfile"]	= "모든 설정값 삭제:";
		["ChatSavedProfile"]	= "저장된 프로필:";
		["ChatUsingProfile"]	= "사용 중인 프로필:";
		["FrmtAutoDeActive"]	= "자동 마력 추출 활성화";
		["FrmtAutoDeDisabled"]	= "자동 마력 추출 비활성화";
		["FrmtAutoDeDisenchantCancelled"]	= "마력 추출이 취소되었습니다: 아이템을 찾을 수 없습니다.";
		["FrmtAutoDeDisenchanting"]	= "%s를 마력 추출합니다.";
		["FrmtAutoDeIgnorePermanent"]	= "%s를 영원히 무시합니다.";
		["FrmtAutoDeIgnoreSession"]	= "%s를 이번 접속 동안만 무시합니다.";
		["FrmtAutoDeInactive"]	= "자동 마력 추출 비활성화";
		["FrmtAutoDeMilling"]	= "%s를 제분합니다.";
		["FrmtAutoDeMillingCancelled"]	= "제분 취소: 아이템을 찾을 수 없습니다.";
		["FrmtAutoDeProspectCancelled"]	= "보석 추출 취소: 아이템을 찾을 수 없습니다.";
		["FrmtAutoDeProspecting"]	= "%s를 보석 추출합니다.";
		["FrmtBidbrokerCurbid"]	= "현재 입찰";
		["FrmtBidbrokerDone"]	= "입찰 중개 완료";
		["FrmtBidbrokerHeader"]	= "입찰이 평균 마력 추출 가격에서 %S 실버 절약되었습니다. (최소 %%less = %d):";
		...
		["FrmtValueAuctVal"]	= "마력 추출 가격 (경매장값)";
		["FrmtValueFixedVal"]	= "마력 추출 가격(Fixed)";
		["FrmtValueMarket"]	= "마력 추출 가격 (기준값)";
		...
		-- Section: User Interface
		["ExportPriceAucAdv"]	= "Enchantrix 가격을 Auctioneer Advanced로 내보냅니다.";
		["GuiActivateProfile"]	= "현재 프로필 활성화";
		["GuiAutoDeBoughtForDE"]	= "마력 추출용으로 구입된 아이템만";
		["GuiAutoDeEnable"]	= "가방에서 마력추출할 아이템을 찾습니다. - \"주의해서 사용하세요.\"";
		["GuiAutoDeEpicItems"]	= "영웅 (보라색) 아이템 자동 마력 추출";
		...
		["ModTTShow_shift"]	= "Shift 키가 눌렸을 때";
	...
	nlNL = {
		...
		["ShowGuessAuctioneerVal"]	= "waardeer-waarde";
		["ShowTerse"]	= "Beknopt";
		["ShowUI"]	= "toon";
		...
		-- Section: Help Text
		["GuiClearall"]	= "Alle Enchantrix Data opschonen";
		...
		["GuiDELevels"]	= "Toon benodigde disenchant level in de tooltip";
		["GuiDEMaterials"]	= "Toon disenchant materiaalinformatie in de tooltip";
		["GuiEmbed"]	= "Voeg informatie toe aan in-game tooltip";
		...
		["GuiPrintin"]	= "Selecteer het gewenste berichtenscherm";
		["GuiPrintYieldsInChat"]	= "Toon itemopbrengsten in chat venster";
		["GuiShowCraftReagents"]	= "Toon maak-benodigdheden in tooltips";
		...
		["GuiValuateMedian"]	= "Taxeer met Auctioneer gemiddelden";
		["HelpClear"]	= "Verwijder de gegevens van het geselecteerde item (je moet met shift-click de items in je commando invoeren) Je kunt ook het speciale keyword \"all\" opgeven";
	...
	ruRU = {
		...
		-- Section: Generic Messages
		["FrmtCredit"]	= "(на http://enchantrix.org/ можно поделиться собранной аддоном информацией)";
		...
		["GuiDELevels"]	= "Показать в подсказке уровень зачарования, необходимый для распыления предмета";
		["GuiDEMaterials"]	= "Показать, на какие материалы в среднем распыляется предмет";
		...
		["GuiShowCraftReagents"]	= "Показать скрафченные реагенты во всплывающей подсказке предмета";
		...
		["HelpEmbed"]	= "Отображать текст в верхней подсказке. (Некоторые возможности будут отключены).";
		...
		["ChatResetProfile"]	= "Сброшены настройки профиля";
		["ChatSavedProfile"]	= "Сохранен профиль";
		["ChatUsingProfile"]	= "Используется профиль";
		...
		-- Section: User Interface
		["BeanCounterRequired"]	= "Для включения автоматического распыления предметов нужно установить аддон BeanCounter. С помощью этого аддона можно отследить, был ли куплен предмет специально для распыления, что позволит автоматизировать процедуру.";
		["ExportPriceAucAdv"]	= "Экспорт цен Enchantrix в Auctioneer Advanced";
		["GuiActivateProfile"]	= "Включить выбранный профиль";
		["GuiAutoDeBoughtForDE"]	= "Только предметы, купленные для распыления";
		["GuiAutoDeEnable"]	= "Поиск распыляемых предметов в сумках (Автораспыление - использовать с осторожностью!)";
		...
		["GuiAutoLootDE"]	= "Автоматически забирать распыленные\просеянные\измельченные в Ручную ингредиенты";
		...
		["GuiConfigProfiles"]	= "Создание и редактирование профилей";
		...
		["GuiDuplicateProfileButton"]	= "Копировать";
		["GuiFixedSettings"]	= "Фиксированные цены на реагенты";
		["GuiFixedSettingsNote"]	= "Если галочка перед реагентом включена, то указанная стоимость будет использована вместо любых других цен (например, полученных из Auctioneer'а). На эту стоимость влияет калибровка ценности реагентов (производится в соответствующем разделе настроек). Поэтому, чтобы стоимость реагента совпадала с введенным значением, убедитесь, что в разделе калибровки напротив реагента стоит 100%.";
		["GuiGeneralOptions"]	= "Общие настройки";
		...
		["GuiMinimapButtonAngle"]	= "Положение кнопки: %d";
		["GuiMinimapButtonDist"]	= "Расстояние: %d";
		["GuiMinimapOptions"]	= "Кнопка на мини-карте";
		["GuiMinimapShowButton"]	= "Отображать кнопку";
		...
		["GuiPLBBSettings"]	= "Проценты и Bidbroker настройки";
		...
		["GuiShowMatSources"]	= "Показать материал получаемый из вещей при распылении, просеивании и измельчении.";
		...
		["GuiWeighSettingsNote"]	= "Изменение веса оценки предоставленного реагента. В общем вы должны оставить их в 100%, до тех пор пока не найдете что они должны быть более или менее ценны чем вам предоставляет метод оценки, который вы используете. (The weights above change the valuation of the given reagent by the specified amount. Generally you will want to leave them at 100% unless you think they should be more or less valuable than the valuation method you are using is saying.)";
	...
	zhCN = {
		...
		["FrmtActUnknownLocale"]	= "找不到您选择的语言('%s')。可用的语言有：";
		["FrmtPrintin"]	= "附魔助手信息现在将显示在\"%s\"对话框";
		["FrmtUsage"]	= "用途：";
		["MesgDisable"]	= "禁用附魔助手的自动载入功能";
		["MesgNotloaded"]	= "附魔助手没有加载。键入/enchantrix 取得更多信息";
		...
		["GuiOtherHeader"]	= "其他选项";
		["GuiOtherHelp"]	= "附魔助手 杂项设定";
		["GuiPrintin"]	= "选择期望的信息框架";
		["GuiPrintYieldsInChat"]	= "在聊天视窗显示物品产出的结果";
		["GuiShowCraftReagents"]	= "在提示资讯中显示制作物品所需材料";
		["GuiTerse"]	= "开启简洁模式";
		...
		["HelpEmbed"]	= "嵌入文字到原游戏提示资讯中(提示：部分功能在该模式下无法使用)";
		["HelpFindBidauct"]	= "找到分解价值可能低于竞标价一定银币额的拍卖品";
		["HelpFindBuyauct"]	= "找到分解价值可能低于直接购买价一定比率的拍卖品";
		["HelpGuessAuctioneer5Val"]	= "开启估价功能并且有安装拍卖助手，就显示物品分解的市场价值";
		...
		["HelpLocale"]	= "改变用来显示Enchantrix讯息的语言";
		["HelpOnoff"]	= "开/关附魔数据显示";
		["HelpPrintin"]	= "选择附魔助手使用哪个窗口来显示输出讯息。你可以指定窗口名称或索引。";
		["HelpShowDELevels"]	= "在提示资讯中选择是否显示分解物品需要的附魔技能";
		["HelpShowDEMaterials"]	= "在提示资讯咨询中选择否是显示分解物品产生的材料资讯";
		["HelpShowUI"]	= "显示或隐藏设置面板";
		["HelpTerse"]	= "开启/关闭简略模式，只显示分解价值。按住Ctrl键将无视此设定。";
		...
		-- Section: Tooltip Messages
		["Click"]	= "单击";
		["EnxMMTip"]	= "附魔助手(Enchantrix)显示物品分解，选矿，研磨后得到的产物。";
		["FrmtBarkerPrice"]	= "Barker价格(%d%% 最低利润)";
		["FrmtDEItemLevels"]	= "可自物品等级 %d 到 %d 中的物品分解后获得。";
		["FrmtDisinto"]	= "可分解为:";
		["FrmtFound"]	= "发现%s可分解为：";
		...
		["RightClick"]	= "右击";
		["ShiftClick"]	= "Shift+单击";
		["TipOpenConfig"]	= "编辑配置文件";
		["TipOpenEnchant"]	= "打开附魔窗口";
		["TipOpenJewel"]	= "打开珠宝制作窗口";
		["TooltipMillingLevel"]	= "研磨必要技能%d";
		["TooltipProspectLevel"]	= "选矿必要技能%d";
		["TooltipShowDisenchantLevel"]	= "分解必要技能%d";

		-- Section: User Interface
		["BeanCounterRequired"]	= "必须安装 BeanCounter 才能决定收益因子。 关闭 AutoDE 限制直到安装了 BeanCounter。";
		["ExportPriceAucAdv"]	= "将Enchantrix的价格信息导出到AuctioneerAdvanced";
		["GuiActivateProfile"]	= "激活当前配置";
		["GuiAutoDeBoughtForDE"]	= "只为了分解而购买的物品";
		["GuiAutoDeEnable"]	= "监视背包的可分解物品-小心使用";
		["GuiAutoDeEpicItems"]	= "自动分解史诗(紫)物品";
		["GuiAutoDeOptions"]	= "自动";
		["GuiAutoDePromptLine1"]	= "确认要分解：";
		["GuiAutoDePromptLine3"]	= "贵重的%s";
		["GuiAutoDEPurchaseReason"]	= "%s 已购入";
		["GuiAutoDeRareItems"]	= "自动分解稀有(蓝)物品";
		["GuiAutoDESuggestion"]	= "建议：%s 此物品";
		["GuiAutoLootDE"]	= "自动拾取,手动分解,选矿，研磨物品.";
		...
		["GuiItemValueAuc5Appraiser"]	= "AucAdv评估价";
		...
		["GuiShowMatSources"]	= "显示自分解、探勘及研磨物品时取得的各原始物料信息。";
		...
		["GuiYes"]	= "是";
		["ModTTShow"]	= "显示提示信息:";
		["ModTTShow_alt"]	= "当Alt被按下";
		["ModTTShow_always"]	= "总是";
		["ModTTShow_ctrl"]	= "当Ctrl被按下";
		["ModTTShow_never"]	= "从不";
		["ModTTShow_noalt"]	= "当Alt没被按下";
		["ModTTShow_noctrl"]	= "当Ctrl没被按下";
		["ModTTShow_noshift"]	= "当Shift没被按下";
		["ModTTShow_shift"]	= "当Shift被按下";
	...
	zhTW = {
		...
		-- Section: Command Messages
		["FrmtActClearall"]	= "清除所有附數據";
		["FrmtActClearFail"]	= "無法找到物品：%s";
		["FrmtActClearOk"]	= "清除物品數據：%s";
		["FrmtActDefault"]	= "附魔助手的%s選項已重設為預設值";
		["FrmtActDefaultAll"]	= "所有附魔助手的%s選項已重設為預設值";
		["FrmtActDisable"]	= "不顯示物品的 %s 數據";
		["FrmtActEnable"]	= "顯示物品的 %s 數據";
		["FrmtActSet"]	= "設定 %s 為 '%s'";
		["FrmtActUnknown"]	= "未知的命令關鍵字：'%s'";
		["FrmtActUnknownLocale"]	= "找不到您選擇的語言('%s')。可用的語言有：";
		["FrmtPrintin"]	= "附魔助手的訊息將會顯示在\"%s\"聊天框";
		["FrmtUsage"]	= "用途：";
		["MesgDisable"]	= "關閉附魔助手的自動載入功能";
		["MesgNotloaded"]	= "附魔助手尚未載入，輸入/enchantrix 取得更多資訊.";
		...
		-- Section: Help Text
		["GuiAltChatlink"]	= "使用 ALT+滑鼠左鍵 自聊天連結開啟提示窗";
		...
		["GuiPrintin"]	= "選擇期望的信息框架";
		["GuiPrintYieldsInChat"]	= "在聊天視窗顯示物品產出的結果";
		["GuiShowCraftReagents"]	= "在提示資訊中顯示製作物品所需材料";
		["GuiTerse"]	= "啟用精簡模式";
		["GuiValuateAverages"]	= "以拍賣助手平均價進行估價";
		["GuiValuateBaseline"]	= "以內置資料估價";
		["GuiValuateEnable"]	= "啟用估價";
		["GuiValuateHeader"]	= "估價";
		["GuiValuateMedian"]	= "以拍賣助手中位數進行估價";
		["HelpAltChatlink"]	= "啟用對聊天視窗中的物品連結按下 ALT 與 滑鼠左鍵 來顯示一個提示窗的功能";
		["HelpClear"]	= "清除指定物品的資料(必須 Shift+點擊 將物品插入到此命令)。你也可以指定特定關鍵字 \"all\" 。";
		["HelpDefault"]	= "設置某個附魔助手選項為預設值。你也可以輸入特定關鍵字 \"all\" 來重置所有附魔助手的選項到其預設值。";
		["HelpDisable"]	= "停止附魔助手並在下一次登錄遊戲時自動載入。";
		["HelpEmbed"]	= "嵌入文字到原遊戲提示資訊中(提示：部分功能在該模式下無法使用)";
		...
		["HelpShowDELevels"]	= "在提示資訊中選擇是否顯示分解物品需要的附魔技能";
		...
		["ModTTShow_Help"]	= "決定你要的提示窗運作模式。\n總是： 每次都顯示附魔助手的提示窗。\n當Modifier key被按下：只在此按鍵被按下時才會顯示附魔助手提示窗。\n當Modifier key沒被按下：只在此按鍵沒被按下時才會顯示附魔助手提示窗。\n從不：永遠不顯示附魔助手的提示窗。\n啟用本選項將會使附魔助手的額外提示窗只在ALT按下時才顯示。";
		...
		-- Section: Tooltip Messages
		["Click"]	= "左鍵點擊";
		["EnxMMTip"]	= "Enchantrix 將會顯示一個物品是否可分解、探勘和研磨後的資訊。這也會提供將這些資訊整合到拍賣助手中以做為進行拍賣物販售或購買時的依據。";
		...
		["RightClick"]	= "右鍵點擊";
		["ShiftClick"]	= "Shift+左鍵點擊";
		["TipOpenConfig"]	= "編輯配置。";
		["TipOpenEnchant"]	= "打開附魔視窗。";
		["TipOpenJewel"]	= "打開珠寶設計視窗。";
		...
		["GuiAutoLootDE"]	= "手動自動搶劫幻想，展望，或碾磨項目。";
		["GuiAutoMillingPromptLine1"]	= "您正要研磨：";
		...
		["ModTTShow_always"]	= "總是";
		["ModTTShow_ctrl"]	= "當Ctrl被按下";
		["ModTTShow_never"]	= "從不";
		["ModTTShow_noalt"]	= "當Alt鍵沒有被按下";
		["ModTTShow_noctrl"]	= "當Ctrl沒有被按下";
		["ModTTShow_noshift"]	= "當Shift沒有被按下";
		["ModTTShow_shift"]	= "當Shift被按下";
