...
function private.CreateFrames()
	...
	base:SetResizeBounds(834, 450, 1500, 450)
	...
	base.Done = CreateFrame("Button", nil, base, "UIPanelButtonTemplate")
	base.Done:SetSize(90, 21)
	...
	frame.searchButton:SetSize(90, 21)
	...
	frame.exactCheck = CreateFrame("CheckButton", "BeancounterexactCheck", frame, "OptionsSmallCheckButtonTemplate")
	...
	--search classic data
	frame.neutralCheck = CreateFrame("CheckButton", "BeancounterneutralCheck", frame, "OptionsSmallCheckButtonTemplate")
	...
	--search bids
	frame.bidCheck = CreateFrame("CheckButton", "BeancounterbidCheck", frame, "OptionsSmallCheckButtonTemplate")
	...
	frame.bidFailedCheck = CreateFrame("CheckButton", "BeancounterbidFailedCheck", frame, "OptionsSmallCheckButtonTemplate")
	...
	--search Auctions
	frame.auctionCheck = CreateFrame("CheckButton", "BeancounterauctionCheck", frame, "OptionsSmallCheckButtonTemplate")
	...
	frame.auctionFailedCheck = CreateFrame("CheckButton", "BeancounterauctionFailedCheck", frame, "OptionsSmallCheckButtonTemplate")
	...
	frame.useDateCheck = CreateFrame("CheckButton", "BeancounteruseDateCheck", frame, "OptionsSmallCheckButtonTemplate")
	...
	frame.resultlist.sheet = ScrollSheet:Create(frame.resultlist, {
		...
		{ _BC('UiProfit'), "COIN", get("columnwidth.".._BC('UiProfit')) },
...
function private.createDeleteItemPrompt()
	...
	frame.yes = CreateFrame("Button", nil, frame, "UIPanelButtonTemplate")
	frame.yes:SetSize(90, 21)
	...
	frame.no = CreateFrame("Button", nil, frame, "UIPanelButtonTemplate")
	frame.no:SetSize(90, 21)
...
function private.CreateErrorFrames(error, expectedVersion, playerVersion)
	...
	frame.loadError.close = CreateFrame("Button", nil, frame.loadError, "UIPanelButtonTemplate")
	frame.loadError.close:SetSize(90, 21)
